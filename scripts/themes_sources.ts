 ...
 */
export const vscodeThemesToRename: Record<string, string> = {
  dark_plus: "dark-plus",
 ...
 */
export const marketplaceThemeSources: {
  [extPublisherAndId: string]: [string, string][];
} = {
  "equinusocio.vsc-material-theme": [
    [
      "material-darker.json",
      "extension/build/themes/Material-Theme-Darker.json",
    ],
    [
      "material-default.json",
      "extension/build/themes/Material-Theme-Default.json",
    ],
    [
      "material-lighter.json",
      "extension/build/themes/Material-Theme-Lighter.json",
    ],
  ...
  "zhuangtongfa.material-theme": [[
    "one-dark-pro.json",
    "extension/themes/OneDark-Pro.json",
  ]],
};

 ...
 */
export const vscodeGrammarsToRename: Record<string, string> = {
  "asp-vb-net": "vb",
  batchfile: "bat",
  coffeescript: "coffee",
...
export const githubGrammarSources: [string, string][] = [
  ...
  [
    "blade",
    "https://github.com/spatie/shiki-php/blob/main/languages/blade.tmLanguage.json",
  ],
  [
    "cadence",
  ...
  [
    "cmake",
    "https://github.com/twxs/vs.language.cmake/blob/master/syntaxes/CMake.tmLanguage",
  ],
  [
    "cobol",
  ...
  [
    "codeql",
    "https://github.com/github/vscode-codeql/blob/main/syntaxes/ql.tmLanguage.json",
  ],
  [
    "crystal",
  ...
  [
    "cue",
    "https://github.com/cue-sh/vscode-cue/blob/master/syntaxes/cue.tmLanguage.json",
  ],
 ...
 */
export const marketplaceGrammarSources: {
  [extPublisherAndId: string]: [string, string][];
} = {
